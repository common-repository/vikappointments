...
class VikAppointmentsModelShortcodes extends JModelForm
{
	...
	public function best($views, $lang = null)
	{
		...
		{
			/**
			 * Use the default services view to properly display the output
			 * generated by controller tasks.
			 * 
			 * @since 1.2.14
			 */
			$views = 'services';
		...
		/**
		 * Properly route the packages order as this view doesn't own a XML file.
		 * 
		 * @since 1.2.12
		 */
		if (in_array('packagesorder', $views))
		{
			$views[] = 'packages';
		}
