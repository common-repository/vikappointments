...
class VikAppointmentsLanguageAdminSys implements JLanguageHandler
{
	...
	public function translate($string)
	{
		...
		switch ($string)
		{
			...
			case 'VAP_ACCESS_ANALYTICS_OPTIONS':
				$result = __('Options Analytics', 'vikappointments');
				break;

			case 'VAP_ACCESS_ANALYTICS_OPTIONS_DESC':
				$result = __('This rule allows the users to access the options analytics page.', 'vikappointments');
				break;
