...
class VikAppointmentsLanguageSystem implements JLanguageHandler
{
	...
	public function translate($string)
	{
		...
		switch ($string)
		{
			...
			case 'PLG_RECAPTCHA_ERROR_EMPTY_SOLUTION':
			...
			case 'COM_MENUS_ITEMS_FIELDSET_LABEL':
			...
			case 'COM_MENUS_FILTERS_FIELDSET_LABEL':
			...
			case 'COM_MENUS_LAYOUT_FIELDSET_LABEL':
			...
			case 'COM_MODULES_OPTION_SELECT_MENU_ITEM':
				$result = __('- Select Menu Item -', 'vikappointments');
				break;
			...
			case 'COM_MODULES_FIELD_TITLE_LABEL':
				$result = __('Block Title', 'vikappointments');
				break;

			case 'COM_MODULES_FIELD_TITLE_DESC':
				$result = __('An optional title to be displayed above the block contents.', 'vikappointments');
				break;

			case 'COM_MODULES_PREVIEW_NOT_AVAIL':
				$result = __('Preview not yet available. Try to adjust the configuration of the widget.', 'vikappointments');
				break;
