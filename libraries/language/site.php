...
class VikAppointmentsLanguageSite implements JLanguageHandler
{
	...
	public function translate($string)
	{
		...
		switch ($string)
		{
			...
			case 'VAPMANAGEEMPLOYEE18_DESC_SITE':
				$result = __('Choose if you want to temporarily unpublish your profile to prevent the customers from booking you. You\'ll be immediately reactivated once you become available again.', 'vikappointments');
				break;
