...
class VikAppointmentsBuilder
{
	...
	public static function setupOverridesManager()
	{
		...
		add_action('vikappointments_display_view_configapp_customizer', function($forms, $view, $setup)
		{
			if (!$forms)
			{
				// init forms array
			...
			$forms[__('Page Overrides', 'vikappointments')] = $html;

			// register an icon for this new fieldset
			$setup->icons[__('Page Overrides', 'vikappointments')] = 'fas fa-cut';
