(function(wp) {
	 ...
	 */
	window.vapCreateControlElement = (field, props) => {
		let fieldControl;

		switch (field.layout) {
			case 'html.form.fields.list':
				fieldControl = field.class === 'btn-group btn-group-yesno'
					? new VAPWidgetBlockFieldCheckbox(field)
					: new VAPWidgetBlockFieldList(field);
				break;

			case 'html.form.fields.groupedlist':
				fieldControl = new VAPWidgetBlockFieldGroupedList(field);
				break;

			case 'html.form.fields.textarea':
				fieldControl = new VAPWidgetBlockFieldTextarea(field);
				break;

			case 'html.form.fields.media':
				fieldControl = new VAPWidgetBlockFieldMedia(field);
				break;
			...
			case 'html.form.fields.number':
				...
				// fieldControl = new VAPWidgetBlockFieldNumber(field);
				break;
		}
		...
		if (!fieldControl) {
			switch (field.type) {
				case 'color':
					fieldControl = new VAPWidgetBlockFieldColor(field);
					break;
				...
				case 'html':
					fieldControl = new VAPWidgetBlockFieldHtml(field);
					break;

				default:
					// type not supported, use a text field
					fieldControl = new VAPWidgetBlockFieldText(field);
			}
		}
	 ...
	 */
	const VAPWidgetBlockField = class VAPWidgetBlockField {
		constructor(data) {
			for (let key in data) {
	 ...
	 */
	const VAPWidgetBlockFieldText = class VAPWidgetBlockFieldText extends VAPWidgetBlockField {
		buildElement(props) {
	 ...
	 * @link https://developer.wordpress.org/block-editor/reference-guides/components/text-control/
	 */
	const VAPWidgetBlockFieldTextarea = class VAPWidgetBlockFieldTextarea extends VAPWidgetBlockField {
		buildElement(props) {
			return wp.element.createElement(
	 ...
	 */
	const VAPWidgetBlockFieldNumber = class VAPWidgetBlockFieldNumber extends VAPWidgetBlockField {
		buildElement(props) {
			return wp.element.createElement(
	 ...
	 */
	const VAPWidgetBlockFieldColor = class VAPWidgetBlockFieldColor extends VAPWidgetBlockField {
		buildElement(props) {
			return wp.element.createElement(
	 ...
	 */
	const VAPWidgetBlockFieldCheckbox = class VAPWidgetBlockFieldCheckbox extends VAPWidgetBlockField {
		buildElement(props) {
			return wp.element.createElement(
	 ...
	 */
	const VAPWidgetBlockFieldList = class VAPWidgetBlockFieldList extends VAPWidgetBlockField {
		buildElement(props) {
			return wp.element.createElement(
	 ...
	 * @link https://developer.wordpress.org/block-editor/reference-guides/components/select-control/
	 */
	const VAPWidgetBlockFieldGroupedList = class VAPWidgetBlockFieldGroupedList extends VAPWidgetBlockField {
		constructor(data) {
			super(data);
	 ...
	 */
	const VAPWidgetBlockFieldMedia = class VAPWidgetBlockFieldMedia extends VAPWidgetBlockField {
		buildElement(props) {
	 ...
	 */
	const VAPWidgetBlockFieldHtml = class VAPWidgetBlockFieldHtml extends VAPWidgetBlockField {
		buildElement(props) {
			return wp.element.createElement(
				wp.components.BaseControl,
				{
