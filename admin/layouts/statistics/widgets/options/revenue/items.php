	...
	<table data-widget-id="<?php echo $widget->getID(); ?>">
		...
		<thead>
			<tr>
				...
				<th style="text-align: left;" class="<?php echo $ordering['column'] == 'option' ? 'sorted' : ''; ?>">
					<?php echo JHtml::fetch('vaphtml.admin.customsort', 'VAPOPTIONFIELDSETTITLE1', 'option', $ordering['direction'], $ordering['column'], 'asc'); ?>
				</th>

				<!-- COUNT -->
				
				<th style="text-align: right;" class="<?php echo $ordering['column'] == 'count' ? 'sorted' : ''; ?>">
					<?php echo JHtml::fetch('vaphtml.admin.customsort', 'VAPQUANTITY', 'count', $ordering['direction'], $ordering['column'], 'desc'); ?>
				</th>
		...
		<tbody>
			...
			foreach ($data as $totals)
			{
				...
				<tr>
					...
					<td style="text-align: left;" class="<?php echo $ordering['column'] == 'option' ? 'sorted' : ''; ?>">
		...
		<tfoot>
			<tr>
				...
				<td style="text-align: left;" class="<?php echo $ordering['column'] == 'option' ? 'sorted' : ''; ?>">&nbsp;</td>
