...
<p>This plugin can be used to import any ICS event (following the Google standards) as a new appointment.</p>
...
<script>
	...
	(function($) {
		...
		$(function() {
			...
			onInstanceReady(() => {
				return typeof Joomla.editors.instances.plg_payload !== 'undefined';
			}).then(() => {
				$('#plg-login').trigger('change');
			});
		});
