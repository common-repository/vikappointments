...
class VikAppointmentsControllerConfiguration extends VAPControllerAdmin
{
	...
	public function save()
	{
		...
		$args['calhourheight']      = $input->getUint('calhourheight');
		...
		$args['currency_ecb_enabled']         = $input->getUint('currency_ecb_enabled', 0);
		$args['currency_floatrates_enabled']  = $input->getUint('currency_floatrates_enabled', 0);
		$args['currency_currencyapi_enabled'] = $input->getUint('currency_currencyapi_enabled', 0);
		$args['currency_currencyapi_key']     = $input->getString('currency_currencyapi_key', '');
		$args['currency_currencyapi_cache']   = $input->getUint('currency_currencyapi_cache', 5);
