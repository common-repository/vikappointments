	...
	<div class="vap-order-first">
		...
		if (VAPFactory::getConfig()->getBool('printorders'))
		{
			...
			<div class="vap-printable">
				<a 
					href="<?php echo JRoute::rewrite('index.php?option=com_vikappointments&task=order.doprint&id=' . $order->id . '&sid=' . $order->sid . '&tmpl=component' . ($this->itemid ? '&Itemid=' . $this->itemid : '')); ?>"
					target="_blank"
