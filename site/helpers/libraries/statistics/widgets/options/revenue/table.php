...
/**
 * Widget used to draw a table containing the whole revenue of the options. 
 *
 * @since 1.7.5
 */
class VAPStatisticsWidgetOptionsRevenueTable extends VAPStatisticsWidget
{
	/**
	...
	{
		return $user->authorise('core.access.analytics.finance', 'com_vikappointments') && $user->authorise('core.access.analytics.options', 'com_vikappointments');
	}
	...
	protected function fetchData()
	{
		...
		// fetch options trend
		$data['data'] = VAPStatisticsHelperOptions::getRevenue($filters['datefrom'], $filters['dateto'], [
			'count', 'total', 'tax', 'net', 'discount',
