...
/**
 * Widget used to draw trend chart of the options.
 *
 * @since 1.7.5
 */
class VAPStatisticsWidgetOptionsRevenueChart extends VAPStatisticsWidget
{
	/**
	...
	public function getData()
	{
		...
		// fetch options trend
		$data = VAPStatisticsHelperOptions::getRevenueTrend($filters['datefrom'], $filters['dateto'], $filters['valuetype'], $filters['variations'], $filters['options']);
