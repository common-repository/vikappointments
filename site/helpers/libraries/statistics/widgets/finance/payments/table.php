...
/**
 * Widget used to fetch the most used payment methods.
 *
 * @since 1.7
 */
class VAPStatisticsWidgetFinancePaymentsTable extends VAPStatisticsWidget
{
	/**
	...
	protected function fetchData()
	{
		...
		$data['data'] = VAPStatisticsHelperFinance::getPaymentsData($filters['datefrom'], $filters['dateto']);
