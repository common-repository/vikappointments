...
/**
 * Widget used to fetch the most used coupon codes.
 *
 * @since 1.7
 */
class VAPStatisticsWidgetFinanceCouponsTable extends VAPStatisticsWidget
{
	/**
	...
	protected function fetchData()
	{
		...
		$data['data'] = VAPStatisticsHelperFinance::getCouponsData($filters['datefrom'], $filters['dateto']);
