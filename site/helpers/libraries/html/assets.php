...
abstract class VAPHtmlAssets
{
	...
	public static function currency()
	{
		...
		VAPApplication::getInstance()->addScript(VAPASSETS_URI . 'js/currency.js');
		...
		/**
		 * The JS object now supports a conversion rate.
		 * 
		 * @since 1.7.6
		 */
		$options->conversionRatio = $currency->getConversionRate();
...
(function($) {
	...
	$(function() {
		onInstanceReady(() => {
			...
			VAPCurrency.getInstance('{$symbol}', {$options});
		});
	});
})(jQuery);
JS
